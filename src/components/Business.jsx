    ...
    >
      <div
        className={`w-[64px] h-[64px] rounded-full ${styles.flexCenter} ${
          darkMode ? 'bg-dimBlue' : 'bg-lightBlue'
        }`}
      >
      ...
      <div className="flex-1 flex flex-col ml-3">
        ...
        <p
          className={`font-poppins font-normal text-[16px] leading-[24px] mb-1 ${
...
const Business = () => {
  ...
  return (
    <section
      id="features"
      className={`${ 
        darkMode ? '' : 'bg-gray-100 mt-2' // Light grey background in light mode
      } ${layout.section}`}
    >
