  ...
  return (
    <div className={`relative w-full py-10 px-4 md:px-16 mb-9 ${sectionStyle}`}>
      ...
      <div className="relative z-10 max-w-5xl mx-auto grid md:grid-cols-2 gap-8 items-stretch">
        ...
        {/* Working Hours Card */}
        <div className={`relative rounded-2xl p-6 overflow-hidden ${glassStyle} ${bottomHalfBg} animate-fadeInUp transition-all duration-500`}>
          ...
          {/* Calendar Image */}
          <div className="absolute bottom-2 right-2 w-28 h-28 pointer-events-none">
            <img
              src={calendar3d}
              alt="3D Calendar"
        ...
        {/* Emergency Call Card */}
        <div className={`relative rounded-2xl p-6 text-center md:text-right overflow-hidden ${glassStyle} ${bottomHalfBg} animate-fadeInUp transition-all duration-500`}>
          ...
          {/* Call Image */}
          <div className="absolute bottom-2 left-2 w-28 h-28 pointer-events-none">
            <img
              src={call1}
              alt="Call Icon"
              className="w-full h-full object-contain opacity-90"
