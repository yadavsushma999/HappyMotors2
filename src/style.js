const styles = {
    ...
    hoverCardLight: "hover:bg-gray-200 hover:shadow-sm transition-all duration-300",
    hoverCardDark: "hover:bg-gray-800 hover:shadow-xl transition-all duration-300",
  };
